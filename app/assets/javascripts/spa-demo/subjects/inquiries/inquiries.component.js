(function () {
  ...
  InquirySelectorController.$inject =
    ["$scope", "$stateParams", "spa-demo.authz.Authz", "spa-demo.subjects.Inquiry"];
  ...
  InquiryEditorController.$inject =
    ["$scope", "$q", "$state", "$stateParams", "spa-demo.authz.Authz", "spa-demo.subjects.Inquiry"];
  function InquiryEditorController($scope, $q, $state, $stateParams, Authz, Inquiry) {
    var vm = this;
    vm.create = create;
    vm.clear = clear;
    vm.update = update;
    ...
    function newResource() {
      console.log("newResource() - Inquiry");
      vm.item = new Inquiry();
